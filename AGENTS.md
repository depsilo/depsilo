...
- UI reasoning and values: [docs/design](docs/design/README.md) — principles,
  visual direction, tokens (the only place values live), and component rules.
  The mark and palette are [docs/brand](docs/brand/README.md).
