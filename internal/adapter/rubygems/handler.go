...
func (h *Handler) handleRequest(c *gin.Context) {
	...
	adapter.LogAccess(c.Request.Context(), h.db, "rubygems", c.Request.Method, cacheKey, result.Hit, result.Upstream, time.Since(start), http.StatusOK, c.ClientIP(), written)
}
