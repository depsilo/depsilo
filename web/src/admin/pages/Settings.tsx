          ...
          {activeTab === 'basic' && (
            <CardV2>
              ...
              <div className="space-y-4">
                ...
                <SelectV2 label={t('settings.logLevel')} value={settings.log_level || 'info'} onChange={(e) => updateField('log_level', e.target.value)} className="w-48"><option value="debug">debug</option><option value="info">info</option><option value="warn">warn</option><option value="error">error</option></SelectV2>
              </div>
            </CardV2>
          )}
          ...
          {activeTab === 'storage' && (
            <CardV2>
              ...
              <div className="space-y-4">
                ...
                <SelectV2 label={roLabel(t('settings.dbType'))} value={settings.db_driver || 'sqlite'} disabled className="w-48"><option value="sqlite">SQLite</option><option value="postgres">PostgreSQL</option></SelectV2>
            ...
            <CardV2>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 grid-cols-2">
                  ...
                  <SelectV2 label={t('settings.tokenValidity')} value={settings.token_ttl || '168h'} onChange={(e) => updateField('token_ttl', e.target.value)}><option value="168h">{t('users.days7')}</option><option value="720h">{t('users.days30')}</option><option value="2160h">{t('users.days90')}</option><option value="never">{t('users.neverExpires')}</option></SelectV2>
                </div>
              </div>
            </CardV2>
          )}
