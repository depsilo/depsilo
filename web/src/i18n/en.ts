const en = {
  translation: {
    ...
    settings: {
      ...
      licenseUpgrade: 'Upgrade to Pro · $99 lifetime',
      licenseYearly: 'One-time payment · no subscription',
    },
    ...
    quickstart: {
      ...
      flowIntro: 'Connect one package manager, run a test install, then confirm the request in Monitor.',
      flowLabel: 'Package setup path',
      flowChoose: 'Choose an ecosystem',
      flowCopy: 'Copy the configuration',
      flowVerify: 'Verify in Monitor',
      primaryTitle: 'Connect your package manager',
      primaryDescription: 'Choose your stack. Depsilo generates configuration for this service address.',
      optionalTitle: 'Optional enhancements',
      optionalDescription: 'Add these after your first package request appears in Monitor.',
      ...
      recommendedEcosystems: 'Recommended',
      browseAll: 'Browse all {{count}} ecosystems',
      configureLead: 'Start with {{manager}}; switch only if your project uses another manager.',
      recommendedManager: 'Recommended',
      managerPickerLabel: 'Package manager',
      hideOtherManagers: 'Hide alternatives',
      showOtherManagers: 'Show {{count}} alternatives',
