const en = {
  translation: {
    ...
    quickstart: {
      ...
      heroTitle: 'Delegate the integration to your AI agent',
      ...
      heroDescShort: 'AI reads your code → edits Dockerfile / CI / build → every install routes through the mirror',
      heroSub: 'Paste into Claude Code / Cursor / Copilot Chat — that\'s it',
      heroPreviewLabel: 'Prompt preview',
      heroSizeHint: '~5 KB',
      heroCopyCta: 'Copy the full prompt',
      heroViewFull: 'Read it first',
      heroCompat: 'Claude · Cursor · Copilot',
