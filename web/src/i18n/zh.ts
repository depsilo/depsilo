const zh = {
  translation: {
    ...
    settings: {
      ...
      licenseUpgrade: '升级到 Pro · $99 终身版',
      licenseYearly: '一次付费 · 无订阅',
    },
    ...
    quickstart: {
      ...
      flowIntro: '接入一个包管理器，执行一次测试安装，再到监控页确认请求已通过 Depsilo。',
      flowLabel: '包管理器接入步骤',
      flowChoose: '选择生态',
      flowCopy: '复制配置',
      flowVerify: '前往监控验证',
      primaryTitle: '接入包管理器',
      primaryDescription: '选择技术栈，Depsilo 会按当前服务地址生成可直接使用的配置。',
      optionalTitle: '可选增强',
      optionalDescription: '等第一个包请求出现在监控页后，再按需启用这些能力。',
      ...
      recommendedEcosystems: '推荐',
      browseAll: '浏览全部 {{count}} 个生态',
      configureLead: '建议先使用 {{manager}}；仅当项目使用其他管理器时再切换。',
      recommendedManager: '推荐',
      managerPickerLabel: '包管理器',
      hideOtherManagers: '收起其他管理器',
      showOtherManagers: '展开其他 {{count}} 个管理器',
      quickMethods: '临时接入',
